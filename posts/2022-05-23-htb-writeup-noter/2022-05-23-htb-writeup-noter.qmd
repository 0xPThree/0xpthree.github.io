...
author: "0xPThree"
description: "Noter is an medium-rated machine from Hack The Box. Even though it's medium rating I found this box to be very straight forward with little to none rabbit holes, and thus I would rate it as easy. Doing this box I found a new tool in regards to JWT, and learned about certain MySQL functions. "
date: 2022-05-23
image: images/noter_logo.png
categories: [hackthebox, medium, linux, ftp, bruteforce, flask, subprocess, mysql]
format: html
editor: visual
jupyter: python3
toc: true
...
Browse port 5000 and we are met with a very simple page. ![](images/noter01.png)
...
Blue have two notes and in one of them we find the clear text credentials to the FTP - `blue:blue@Noter!` But we also find the username `ftp_admin`. ![](images/noter05.png)
...
Review the backup files **`app_backup_1638395546`** and we find.. <br> .. **MySQL Config - `app.py`**
...
Review the older backup, **`app_backup_1635803546`**, and we find.. <br> .. **MySQL Config - `app.py`**
...
**Privesc, MySQL User Defined Functions**<br> https://medium.com/r3d-buck3t/privilege-escalation-with-mysql-user-defined-functions-996ef7d5ceaf<br> https://www.exploit-db.com/exploits/1518
