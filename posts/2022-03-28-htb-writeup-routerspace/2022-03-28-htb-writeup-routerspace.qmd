...
**Burp Proxy Settings**: ![](images/routerspace01.png)

We are now able to capture the `Check Status` API call in Burp. ![](images/routerspace02.png)
