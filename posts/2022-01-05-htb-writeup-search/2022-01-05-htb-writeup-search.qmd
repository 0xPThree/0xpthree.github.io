...
author: "0xPThree"
description: "Using a found password and username, the attacker enumerates Active Directory users. They crack a Kerberoastable user’s password and access SMB shares to find sensitive files. By extracting credentials and abusing Active Directory features, they escalate privileges and gain Domain Admin access to capture the root flag."
date: 2022-01-05
image: images/search_logo.png
categories: [hackthebox, windows, mysql, mattermost]
format: html
editor: visual
jupyter: python3
toc: true
