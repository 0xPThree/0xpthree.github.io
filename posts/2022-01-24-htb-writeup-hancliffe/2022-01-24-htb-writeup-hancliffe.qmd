...
author: "0xPThree"
description: "Hancliffe is an hard-rated Windows machine from Hack The Box, and holy fuck is it hard! This is definitely one of the most challenging machines I've done, if not THE most challenging, and also most fun. There's a lot going on here, SSTI, Parser Logic, Firefox Profiles but in the end it's the reversing and binary exploitation parts that shine. I encountered my first ghidra disasembly error throwing me off guard for literally days. I've learned a lot throughout this machine and this is one of my most thorough writeups, so I hope it helps and that you learn aswell! :)"
date: 2022-01-24
image: images/hancliffe_logo.png
categories: [hackthebox, windows, ssti, ngnix, firefox, buffer overflow, socket reuse, aslr]
format: html
editor: visual
jupyter: python3
toc: true
...
![](images/hancliffe03.png)

.. encryption function `encrypt1`

![](images/hancliffe04.png)

.. encryption function `encrypt2`

![](images/hancliffe05.png)
