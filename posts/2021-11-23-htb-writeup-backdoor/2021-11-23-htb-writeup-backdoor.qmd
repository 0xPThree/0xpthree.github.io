...
author: "0xPThree"
description: "The WordPress site had a directory traversal vulnerability in an ebook plugin allowing access to sensitive files and discovery of a running gdbserver, which was exploited for a user shell. Privilege escalation was achieved by attaching to a root-owned SUID screen session, granting full root access."
date: 2021-11-23
image: images/backdoor_logo.png
