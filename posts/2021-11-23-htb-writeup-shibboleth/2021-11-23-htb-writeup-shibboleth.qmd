...
author: "0xPThree"
description: "The Shibboleth box was vulnerable to an IPMI Cipher Zero bypass, revealing the Administrator password. Using it, access to Zabbix was gained, allowing command execution and a shell as the zabbix user. Password reuse gave access to ipmi-svc, where MariaDB credentials were found. Exploiting a MariaDB vulnerability led to root access and the root flag."
date: 2021-11-23
image: images/shibboleth_logo.png
